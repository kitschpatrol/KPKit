...
float __attribute__((overloadable)) KPInRange(float t, float min, float max) {
	return t >= min && t <= max;
}
...
double __attribute__((overloadable)) KPInRange(double t, double min, double max) {
	return t >= min && t <= max;
}
...
long double __attribute__((overloadable)) KPInRange(long double t, long double min, long double max) {
	return t >= min && t <= max;
}
