...
+ (double)mapDouble:(double)value
            fromMin:(double)min1
                max:(double)max1
              toMin:(double)min2
                max:(double)max2 {
  double rangeLength1 = max1 - min1;
  double rangeLength2 = max2 - min2;
  double multiplier = (value - min1) / rangeLength1;
  return multiplier * rangeLength2 + min2;
}

//+ (double)mapDouble:(double)value fromMin:(double)min1 max:(double)max1
// toMin:(double)min2 max:(double)max2 {
//	if (ABS(min1 - max1) < DBL_EPSILON) {
//		//ofLog(OF_LOG_WARNING, "ofMap: avoiding possible divide by
// zero,
// check inputMin and inputMax\n");
//		return min2;
//	}
//    else {
...
+ (CGFloat)mapClamp:(CGFloat)value
            fromMin:(CGFloat)min1
                max:(CGFloat)max1
              toMin:(CGFloat)min2
                max:(CGFloat)max2 {
  return [self clamp:[self map:value fromMin:min1 max:max1 toMin:min2 max:max2]
          betweenMin:min2
                 max:max2];
}
...
CGFloat distanceBetweenCGPoint(CGPoint startPoint, CGPoint endPoint) {
    return hypotf((float)endPoint.x - (float)startPoint.x, (float)endPoint.y - (float)startPoint.y);
}
...
+ (CGFloat)randomBetweenA:(CGFloat)a andB:(CGFloat)b {
  if (a == b) {
    ...
    CGFloat max = a > b ? a : b;
    CGFloat min = a < b ? a : b;
    NSAssert(max - min > 0, @"Your expression returned true for max-min <= 0 "
             @"for some reason... max = %f, min = %f",
             max, min);
...
+ (UIColor *)randomBrightnessOfColor:(UIColor *)color {
  ...
  if ([color getHue:&hue
    ...
    return [UIColor colorWithHue:hue
                      saturation:saturation
                      brightness:[KPKit randomBetweenA:0.5 andB:0.9]
                           alpha:alpha];
  } else {
    // Error, could not convert
    return color;
...
// Easing, via Futil, via Robert Penner, and Jesús Gollonet's port for
// openFrameworks.
...
+ (CGFloat)mapEaseInBack:(CGFloat)value
                 fromMin:(CGFloat)low1
                     max:(CGFloat)high1
                   toMin:(CGFloat)low2
                     max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseOutBack:(CGFloat)value
                  fromMin:(CGFloat)low1
                      max:(CGFloat)high1
                    toMin:(CGFloat)low2
                      max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInOutBack:(CGFloat)value
                    fromMin:(CGFloat)low1
                        max:(CGFloat)high1
                      toMin:(CGFloat)low2
                        max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInBounce:(CGFloat)value
                   fromMin:(CGFloat)low1
                       max:(CGFloat)high1
                     toMin:(CGFloat)low2
                       max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseOutBounce:(CGFloat)value
                    fromMin:(CGFloat)low1
                        max:(CGFloat)high1
                      toMin:(CGFloat)low2
                        max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInOutBounce:(CGFloat)value
                      fromMin:(CGFloat)low1
                          max:(CGFloat)high1
                        toMin:(CGFloat)low2
                          max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInCirc:(CGFloat)value
                 fromMin:(CGFloat)low1
                     max:(CGFloat)high1
                   toMin:(CGFloat)low2
                     max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseOutCirc:(CGFloat)value
                  fromMin:(CGFloat)low1
                      max:(CGFloat)high1
                    toMin:(CGFloat)low2
                      max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInOutCirc:(CGFloat)value
                    fromMin:(CGFloat)low1
                        max:(CGFloat)high1
                      toMin:(CGFloat)low2
                        max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInCubic:(CGFloat)value
                  fromMin:(CGFloat)low1
                      max:(CGFloat)high1
                    toMin:(CGFloat)low2
                      max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseOutCubic:(CGFloat)value
                   fromMin:(CGFloat)low1
                       max:(CGFloat)high1
                     toMin:(CGFloat)low2
                       max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInOutCubic:(CGFloat)value
                     fromMin:(CGFloat)low1
                         max:(CGFloat)high1
                       toMin:(CGFloat)low2
                         max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInElastic:(CGFloat)value
                    fromMin:(CGFloat)low1
                        max:(CGFloat)high1
                      toMin:(CGFloat)low2
                        max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseOutElastic:(CGFloat)value
                     fromMin:(CGFloat)low1
                         max:(CGFloat)high1
                       toMin:(CGFloat)low2
                         max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInOutElastic:(CGFloat)value
                       fromMin:(CGFloat)low1
                           max:(CGFloat)high1
                         toMin:(CGFloat)low2
                           max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInExpo:(CGFloat)value
                 fromMin:(CGFloat)low1
                     max:(CGFloat)high1
                   toMin:(CGFloat)low2
                     max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseOutExpo:(CGFloat)value
                  fromMin:(CGFloat)low1
                      max:(CGFloat)high1
                    toMin:(CGFloat)low2
                      max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInOutExpo:(CGFloat)value
                    fromMin:(CGFloat)low1
                        max:(CGFloat)high1
                      toMin:(CGFloat)low2
                        max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInLinear:(CGFloat)value
                   fromMin:(CGFloat)low1
                       max:(CGFloat)high1
                     toMin:(CGFloat)low2
                       max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseOutLinear:(CGFloat)value
                    fromMin:(CGFloat)low1
                        max:(CGFloat)high1
                      toMin:(CGFloat)low2
                        max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInOutLinear:(CGFloat)value
                      fromMin:(CGFloat)low1
                          max:(CGFloat)high1
                        toMin:(CGFloat)low2
                          max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInQuad:(CGFloat)value
                 fromMin:(CGFloat)low1
                     max:(CGFloat)high1
                   toMin:(CGFloat)low2
                     max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseOutQuad:(CGFloat)value
                  fromMin:(CGFloat)low1
                      max:(CGFloat)high1
                    toMin:(CGFloat)low2
                      max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInOutQuad:(CGFloat)value
                    fromMin:(CGFloat)low1
                        max:(CGFloat)high1
                      toMin:(CGFloat)low2
                        max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInQuart:(CGFloat)value
                  fromMin:(CGFloat)low1
                      max:(CGFloat)high1
                    toMin:(CGFloat)low2
                      max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseOutQuart:(CGFloat)value
                   fromMin:(CGFloat)low1
                       max:(CGFloat)high1
                     toMin:(CGFloat)low2
                       max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInOutQuart:(CGFloat)value
                     fromMin:(CGFloat)low1
                         max:(CGFloat)high1
                       toMin:(CGFloat)low2
                         max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInQuint:(CGFloat)value
                  fromMin:(CGFloat)low1
                      max:(CGFloat)high1
                    toMin:(CGFloat)low2
                      max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseOutQuint:(CGFloat)value
                   fromMin:(CGFloat)low1
                       max:(CGFloat)high1
                     toMin:(CGFloat)low2
                       max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInOutQuint:(CGFloat)value
                     fromMin:(CGFloat)low1
                         max:(CGFloat)high1
                       toMin:(CGFloat)low2
                         max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInSine:(CGFloat)value
                 fromMin:(CGFloat)low1
                     max:(CGFloat)high1
                   toMin:(CGFloat)low2
                     max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseOutSine:(CGFloat)value
                  fromMin:(CGFloat)low1
                      max:(CGFloat)high1
                    toMin:(CGFloat)low2
                      max:(CGFloat)high2 {
...
+ (CGFloat)mapEaseInOutSine:(CGFloat)value
                    fromMin:(CGFloat)low1
                        max:(CGFloat)high1
                      toMin:(CGFloat)low2
                        max:(CGFloat)high2 {
...
+ (NSNumber *)standardDeviationOf:(NSArray *)array {
  ...
  return
      [NSNumber numberWithDouble:sqrt(sumOfSquaredDifferences / [array count])];
}
...
+ (UIView *)firstSuperviewOfView:(UIView *)view
               thatIsKindOfClass:(__unsafe_unretained Class)someClass {
  if (view.superview) {
    if ([view.superview isKindOfClass:someClass]) {
      ...
      return [self firstSuperviewOfView:view.superview
                      thatIsKindOfClass:someClass];
    }
  } else {
...
+ (void)clearCacheDirectory {
  NSArray *cacheDirectory = [[NSFileManager defaultManager]
      contentsOfDirectoryAtPath:[[KPKit cacheDirectory] path]
                          error:NULL];
