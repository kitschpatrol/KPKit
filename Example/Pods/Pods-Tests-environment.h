...
// KPKit
#define COCOAPODS_POD_AVAILABLE_KPKit
#define COCOAPODS_VERSION_MAJOR_KPKit 1
#define COCOAPODS_VERSION_MINOR_KPKit 0
#define COCOAPODS_VERSION_PATCH_KPKit 5
